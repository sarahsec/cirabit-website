...
export const labels = {
  en: {
    ...
    downloadHeroButton: 'Open Cirabit on GitHub',
    ...
    notFoundPageTitle: 'Cirabit · 404',
    notFoundBadge: '404 · Not Found',
    notFoundTitle: 'Page Not Found',
    notFoundMessage: 'The page you requested does not exist or may have moved.',
    notFoundHomeButton: 'Go Home',
    notFoundDownloadButton: 'Open Download',
  ...
  pt: {
    ...
    downloadHeroButton: 'Abrir Cirabit no GitHub',
    downloadPageTitle: 'Cirabit · Download',
    downloadBadge: 'Downloads',
    ...
    notFoundPageTitle: 'Cirabit · 404',
    notFoundBadge: '404 · Não Encontrado',
    notFoundTitle: 'Página não encontrada',
    notFoundMessage: 'A página que você tentou acessar não existe ou foi movida.',
    notFoundHomeButton: 'Ir para o início',
    notFoundDownloadButton: 'Abrir Download',
