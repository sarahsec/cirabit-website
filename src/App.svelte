<script>
  ...
  const labels = {
    en: {
      ...
      heroTitle: 'Decentralized Android messaging, with no central servers.',
      heroDescription:
        'Cirabit focuses on modern dependencies, known bug fixes, native multilingual support, and a steady roadmap for what comes next.',
      ...
      facts: [
        {
          value: 'Independent direction',
          label: 'Clear identity and product focus for Cirabit'
        },
        {
          value: '2 native locales',
          label: 'US English and Brazilian Portuguese'
        },
        {
          value: 'Active maintenance',
          label: 'Focused iteration by the core team'
        }
      ],
      highlightsTitle: 'What makes Cirabit different',
      highlightsDescription:
        'The project direction is practical: improve stability, modernize carefully, and keep the experience lightweight.',
      highlights: [
        {
          title: 'Modern Dependency Stack',
          description:
            'Core libraries are kept fresh so the project stays maintainable and safer over time.'
        },
        {
          title: 'Known Bug Fixes',
          description:
            'Pain points inherited from previous builds are addressed to improve stability in real usage.'
        },
        {
          title: 'Native Language Support',
          description:
            'English (US) and Portuguese (Brazil) are first-class experiences from day one.'
        },
        {
          title: 'Built For What Comes Next',
          description:
            'The project is structured for future enhancements without sacrificing minimalism.'
        }
      ],
      roadmapTitle: 'Near-term roadmap',
      roadmapDescription:
        'Cirabit evolves in small, safe steps that preserve compatibility and keep regressions under control.',
      roadmap: [
        {
          tag: 'NOW',
          title: 'Dependency refresh cadence',
          description:
            'Track key Android dependencies and ship upgrades with focused validation cycles.'
        },
        {
          tag: 'NEXT',
          title: 'Expanded language coverage',
          description:
            'Improve translation depth and prepare the structure for additional community-driven locales.'
        },
        {
          tag: 'NEXT',
          title: 'Known issue hardening',
          description:
            'Continue prioritizing fixes that impact reliability, onboarding, and day-to-day use.'
        },
        {
          tag: 'SOON',
          title: 'Future-ready architecture',
          description:
            'Keep internals modular to support new features without compromising simplicity.'
        }
      ],
      maintainersTitle: 'Main maintainers',
      maintainersDescription:
        'Cirabit is actively maintained by people focused on reliability, openness, and practical improvements.',
      maintainerProfiles: {
        sarah: {
      ...
      contributeDescription:
        'Ideas, bug reports, and pull requests are welcome. Community feedback helps prioritize what comes next.',
    ...
    pt: {
      ...
      heroDescription:
        'O Cirabit foca em dependências modernas, correções de bugs conhecidos, suporte multilíngue nativo e um roadmap contínuo de evolução.',
      ...
      facts: [
        {
          value: 'Direção independente',
          label: 'Identidade clara e foco próprio para o Cirabit'
        },
        {
          value: '2 idiomas nativos',
          label: 'Inglês dos EUA e Português do Brasil'
        },
        {
          value: 'Manutenção ativa',
          label: 'Evolução contínua com foco em qualidade'
        }
      ],
      highlightsTitle: 'O que diferencia o Cirabit',
      highlightsDescription:
        'A direção do projeto é pragmática: melhorar estabilidade, modernizar com cuidado e manter a experiência leve.',
      highlights: [
        {
          title: 'Dependências Modernizadas',
          description:
            'As bibliotecas centrais se mantêm atualizadas para garantir manutenção mais simples e mais segurança com o tempo.'
        },
        {
          title: 'Correções de Bugs Conhecidos',
          description:
            'Pontos críticos herdados de versões anteriores são tratados para melhorar a estabilidade no uso real.'
        },
        {
          title: 'Idiomas com Suporte Nativo',
          description:
            'Inglês (EUA) e Português (Brasil) são experiências de primeira classe desde o início.'
        },
        {
          title: 'Pronto Para Evoluir',
          description:
            'O projeto foi estruturado para futuras melhorias sem perder a proposta minimalista.'
        }
      ],
      roadmapTitle: 'Roadmap de curto prazo',
      roadmapDescription:
        'O Cirabit evolui em passos pequenos e seguros para preservar compatibilidade e evitar regressões.',
      roadmap: [
        {
          tag: 'AGORA',
          title: 'Cadência de atualização de dependências',
          description:
            'Acompanhar dependências importantes do Android e publicar upgrades com validação focada.'
        },
        {
          tag: 'PRÓXIMO',
          title: 'Expansão de cobertura de idiomas',
          description:
            'Aprofundar as traduções e preparar a estrutura para novos idiomas da comunidade.'
        },
        {
          tag: 'PRÓXIMO',
          title: 'Fortalecimento de issues conhecidas',
          description:
            'Seguir priorizando correções que impactam confiabilidade, onboarding e uso diário.'
        },
        {
          tag: 'EM BREVE',
          title: 'Arquitetura pronta para o futuro',
          description:
            'Manter os componentes internos modulares para habilitar novos recursos sem perder simplicidade.'
        }
      ],
      maintainersTitle: 'Principais mantenedores',
      maintainersDescription:
        'O Cirabit é mantido ativamente por pessoas focadas em confiabilidade, colaboração e melhorias práticas.',
      maintainerProfiles: {
        sarah: {
      ...
      contributeDescription:
        'Ideias, relatos de bugs e pull requests são bem-vindos. O feedback da comunidade ajuda a definir os próximos passos.',
